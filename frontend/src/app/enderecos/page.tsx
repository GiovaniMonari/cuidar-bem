  ...
  return (
    <main className="min-h-screen bg-gray-50/70 px-4 py-10 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto space-y-8">
        <header><div className="flex items-center gap-3 text-primary-700 mb-2"><MapPin className="w-6 h-6" /><span className="text-sm font-semibold uppercase tracking-wide">Perfil do cliente</span></div><h1 className="text-3xl font-bold text-gray-900">Meus endereços</h1><p className="text-gray-600 mt-2">Salve endereços validados para agilizar seus próximos atendimentos.</p></header>
        <div className="grid gap-6 lg:grid-cols-[1fr_380px] items-start">
          <Card className="shadow-sm"><CardHeader><CardTitle>Endereços salvos</CardTitle></CardHeader><CardContent className="space-y-3">

...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center gap-2 rounded-xl px-3 py-3 text-sm font-medium text-gray-700 outline-none select-none transition-colors hover:bg-primary-50 focus:bg-primary-50 focus:text-primary-700 data-[highlighted]:bg-primary-50 data-[highlighted]:text-primary-700 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
      {...props}
    >
